						...
						<nav aria-label="breadcrumb">
							<ul class="breadcrumb">
								...
								<li class="breadcrumb__item"><a class="breadcrumb__link"
									href="https://getbootstrap.com/docs/5.0/components/breadcrumb/#example">danh
										sách sản phẩm</a></li>
								<li class="breadcrumb__divider"></li>
								<li class="breadcrumb__item">sản phẩm ${product.name }</li>
							</ul>
						</nav>
					</div>
				</div>
				<div class="paper-wrapper">
					...
					<div class="table-container">
						<table>
							<thead>
								<tr>
									<th class="th-header"><span>Mã chi tiết sản phẩm</span></th>
									<th class="th-header"><span>SKU</span></th>
									<th class="th-header"><span>Ảnh chi tiết</span></th>
							...
							<tbody>
								<c:forEach items="${listProductItem}" var="element">
									<tr>
										...
										<td class="td-body">${element.SKU }</td>
										<td class="td-body">
										...
										<td class="td-body">
											<div class="group-btn">
												<a
													href="${contextPath}/admin/product/product-config/${product.id }/edit/${element.id }.htm">
